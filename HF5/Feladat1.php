...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['firstName'])) {
        ...
        $firstNameErr = "<br>" . "Please use letters as well!";
        $correct = false;
    } elseif (!preg_match("/^[a-zA-Z-' ]*$/", $_POST['firstName'])) {
        $firstNameErr = "<br>" . "Only letters and white space allowed!";
        $correct = false;
    }
    ...
    if (empty($_POST['lastName'])) {
        ...
        $lastNameErr = "<br>" . "Please use letters as well!";
        $correct = false;
    } elseif (!preg_match("/^[a-zA-Z-' ]*$/", $_POST['lastName'])) {
        $lastNameErr = "<br>" . "Only letters and white space allowed!";
        $correct = false;
    }
    ...
    if ($correct) {
        ...
        echo "<p>" . "I will attend: " . "<br>";
        foreach ($_POST['attend'] as $event) {
            echo $event . "<br>";
        }
        echo "</p>";
        echo "<p>" . "Your T-Shirt size is ";
        if ($_POST['tshirt'] == "P") {
        ...
        echo "</p>";
        echo "<p>" . 'File name is: ' . $_FILES['abstract']['name'] . "</p>";
    }
}
?>
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
    ...
    <span style="color:red;"><?php echo $pdfErr; ?></span>
    <br><br>
